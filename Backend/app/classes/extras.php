...
class Extras {
	...
	function __construct()
	{
		...
		$this->mainurl = "http://balabox-demos.com/wuoof/backend/";
		$this->dblocation = "localhost";
		$this->dbuser = "balaboxd_usrwoof";
		$this->dbpass = "thHZJjJYjsEu";
		$this->db = "balaboxd_wuoof";
		...
		//Permalinks
		$this->home_url = "http://balabox-demos.com/wuoof/backend/";
