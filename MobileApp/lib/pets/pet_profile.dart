...
class PetProfile extends StatefulWidget {
  ...
  PetProfile(this.user_id);

  @override
  _PetProfile createState() => _PetProfile();
}

class _PetProfile extends State<PetProfile> {
  ...
  Widget build(BuildContext context) {
    AppBar appBar = partner_appbar(context, "Perfil de "+pet_name);
          ...
          Container(
           ...
           decoration: BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage('images/pet-partner-bg.png'),
                              fit: BoxFit.cover,
