...
class PartnerOfferedHotel extends StatefulWidget {
  @override
  _PartnerOfferedHotelState createState() => _PartnerOfferedHotelState();
}

class _PartnerOfferedHotelState extends State<PartnerOfferedHotel> {
  ...
  Widget build(BuildContext context) {
    AppBar appBar = partner_appbar(context, "Hospedaje");
                                          ...
                                          decoration: BoxDecoration(
                                              ...
                                              borderRadius:
                                                  BorderRadius.circular(
                                                      5)),
                                          child: Text(
                                            "Precio recomendado \$250.00 por día",
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 12),
