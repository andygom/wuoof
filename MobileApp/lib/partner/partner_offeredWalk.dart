...
class PartnerOfferedWalk extends StatefulWidget {
  @override
  _PartnerOfferedWalkState createState() => _PartnerOfferedWalkState();
}

class _PartnerOfferedWalkState extends State<PartnerOfferedWalk> {
  ...
  Widget build(BuildContext context) {
    AppBar appBar = partner_appbar(context, "Paseador");
                          ...
                          child: images.isEmpty
                              ? Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Text("Toca agregar imágenes de tu servicio")
                                  ],
                                )
                              : Align(
                                  child: buildGridView(),
                                    ...
                                    child: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            "Precio recomendado \$250.00 por paseo",
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 12),
