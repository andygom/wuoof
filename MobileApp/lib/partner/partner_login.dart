...
class PartnerLogin extends StatefulWidget {
  PartnerLogin({Key key, this.title}) : super(key: key);
  final String title;
  static _PartnerLogin of(BuildContext context) =>
      context.ancestorStateOfType(const TypeMatcher<_PartnerLogin>());

  @override
  _PartnerLogin createState() => _PartnerLogin();
}

class _PartnerLogin extends State<PartnerLogin> {
  int _counter = 0;
  ...
  goHome(context) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => PartnerHome(0)),
    );
  }
                ...
                Container(
                  decoration: new BoxDecoration(
                    gradient: new LinearGradient(
                        colors: [primary_green, Colors.lime],
